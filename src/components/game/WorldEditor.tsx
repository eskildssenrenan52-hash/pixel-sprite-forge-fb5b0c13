...
import { createMonster } from '@/lib/game/monsterFactory'
...
const UNWALKABLE: TileType[] = ['water', 'deepwater', 'wall', 'dungeon_wall', 'dungeon_brick', 'lava', 'tree', 'rock', 'house_wall', 'house_roof', 'fence', 'ice', 'frozen_tree', 'ice_rock', 'volcanic_rock', 'obsidian', 'volcanic_vent', 'portal', 'crystal_portal', 'haunted_portal', 'sky_portal', 'mountain_portal', 'ruins_portal', 'tower_portal', 'forest_portal', 'desert_portal', 'volcano_portal', 'abyss_portal', 'dungeon_portal', 'ocean_portal', 'celestial_portal', 'rune_altar']
