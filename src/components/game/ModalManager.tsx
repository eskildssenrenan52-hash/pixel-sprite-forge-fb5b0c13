...
export function useModalManager() {
  const [modals, setModals] = useState<Record<ModalType, ModalState>>({
    ...
    skilltree: { isOpen: false, type: 'skilltree', priority: 3 },
    ...
    continents30: { isOpen: false, type: 'continents30', priority: 2 },
    mercenaries: { isOpen: false, type: 'mercenaries', priority: 2 },
    ship: { isOpen: false, type: 'ship', priority: 2 },
